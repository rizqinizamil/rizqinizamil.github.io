...
!function (e, n, t) {
  function r(e, n) {
    ...
    var e, n, t, o, i, s, f;for (var a in h) {
      if (h.hasOwnProperty(a)) {
        if (e = [], n = h[a], n.name && (e.push(n.name.toLowerCase()), n.options && n.options.aliases && n.options.aliases.length)) for (t = 0; t < n.options.aliases.length; t++) {
          ...
          s = e[i], f = s.split("."), 1 === f.length ? Modernizr[f[0]] = o : (!Modernizr[f[0]] || Modernizr[f[0]] instanceof Boolean || (Modernizr[f[0]] = new Boolean(Modernizr[f[0]])), Modernizr[f[0]][f[1]] = o), g.push((o ? "" : "no-") + f.join("-"));
        }
      }
    }
  }function i(e) {
    ...
    var i,
      ...
      f = l("div"), f.id = o ? o[r] : u + (r + 1), d.appendChild(f);
    ...
    function a() {
      ...
      var u = c(e, o);if (!r(u, "undefined")) return u;
    }for (var p, d, m, v, h, y = ["modernizr", "tspan"]; !z.style;) {
      p = !0, z.modElem = l(y.shift()), z.style = z.modElem.style;
    }for (m = e.length, d = 0; m > d; d++) {
      if (v = e[d], h = z.style[v], s(v, "-") && (v = i(v)), z.style[v] !== t) {
        if (f || r(o, "undefined")) return a(), "pfx" == n ? v : !0;try {
          z.style[v] = o;
        } catch (g) {}if (z.style[v] != h) return a(), "pfx" == n ? v : !0;
      }
    }return a(), !1;
  }function v(e, n, t, o, i) {
    var s = e.charAt(0).toUpperCase() + e.slice(1),
        f = (e + " " + w.join(s + " ") + s).split(" ");return r(n, "string") || r(n, "undefined") ? m(f, n, o, i) : (f = (e + " " + _.join(s + " ") + s).split(" "), a(f, n, t));
  }var h = [],
      ...
      C = "Moz O ms Webkit",
      w = y._config.usePrefixes ? C.split(" ") : [];y._cssomPrefixes = w;var x = function x(n) {
    var r,
        o = prefixes.length,
      ...
      var f = prefixes[s],
          a = f.toUpperCase() + "_" + r;if (a in i) return "@-" + f.toLowerCase() + "-" + n;
    }return !1;
  };y.atRule = x;var _ = y._config.usePrefixes ? C.toLowerCase().split(" ") : [];y._domPrefixes = _;var S = n.documentElement,
      b = "svg" === S.nodeName.toLowerCase(),
      E = { elem: l("modernizr") };Modernizr._q.push(function () {
    delete E.elem;
  });var z = { style: E.elem.style };Modernizr._q.unshift(function () {
    delete z.style;
  }), y.testAllProps = v;var P = y.prefixed = function (e, n, t) {
    return 0 === e.indexOf("@") ? x(e) : (-1 != e.indexOf("-") && (e = i(e)), n ? v(e, n, t) : v(e, "pfx"));
  };Modernizr.addTest("objectfit", !!P("objectFit"), { aliases: ["object-fit"] }), o(), delete y.addTest, delete y.addAsyncTest;for (var T = 0; T < Modernizr._q.length; T++) {
    Modernizr._q[T]();
